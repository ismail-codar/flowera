...
export interface IWorkflowDaprServiceInvocationNode<N extends string>
  extends IWorkflowActionNode<N, "serviceInvocation"> {
...
export interface IWorkflowDaprWaitForExternalEventNode<N extends string>
  extends IWorkflowActionNode<N, "daprWaitForExternalEvent"> {
